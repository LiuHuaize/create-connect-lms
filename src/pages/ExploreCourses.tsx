    ...
    <div className="animate-fade-in p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-12">
        <h2 className="text-xl font-medium text-gray-800 mb-4 flex items-center">
          <span>特色课程</span>
          <span className="ml-2 px-2 py-0.5 text-xs rounded-full bg-gray-100 text-gray-600">新上线</span>
        </h2>
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 hover:shadow-md transition-all duration-300">
          <div className="flex flex-col md:flex-row gap-6">
            <div className="w-full md:w-1/3 h-60 overflow-hidden rounded-lg">
              <div className="w-full h-full overflow-hidden relative">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <span className="inline-block px-2 py-1 text-xs font-medium text-white bg-gray-900/80 rounded-md mb-1">PBL项目式学习</span>
                  <h3 className="text-lg font-medium text-white">西游记创新编程课</h3>
                </div>
              </div>
            </div>
            ...
            <div className="w-full md:w-2/3 flex flex-col justify-between">
              <div>
                <h3 className="text-xl font-medium text-gray-800 mb-2">西游记PBL项目课程</h3>
                <p className="text-sm font-medium text-gray-500 mb-3">假如你穿越到古代，成为师徒四人的技术负责人</p>
                ...
                <div className="flex flex-wrap gap-1 mb-4">
                  <span className="text-xs px-2 py-0.5 bg-gray-100 text-gray-600 rounded-md">人物分析</span>
                  <span className="text-xs px-2 py-0.5 bg-gray-100 text-gray-600 rounded-md">产品设计</span>
                  <span className="text-xs px-2 py-0.5 bg-gray-100 text-gray-600 rounded-md">流程图绘制</span>
                  <span className="text-xs px-2 py-0.5 bg-gray-100 text-gray-600 rounded-md">网站制作</span>
                  <span className="text-xs px-2 py-0.5 bg-gray-100 text-gray-600 rounded-md">创意思维</span>
                </div>
              </div>
              ...
              <div className="flex flex-wrap justify-between items-center">
                ...
                <button 
                  ...
                  className="px-4 py-2 bg-gray-800 hover:bg-gray-700 text-white text-sm font-medium rounded-lg shadow-sm transition-all duration-200"
                >
                  立即加入课程
                </button>
              </div>
