...
import { Book, Clock, Award, User, GraduationCap, ArrowLeft, CheckCircle, AlertCircle, Loader2 } from 'lucide-react';
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2">
          {/* 封面图 */}
          <div 
            className="w-full h-64 md:h-80 rounded-xl mb-6 bg-gradient-to-r from-gray-100 to-gray-200 bg-cover bg-center relative overflow-hidden"
            style={{ 
          ...
          <p className="text-gray-600 mb-6">{course.short_description || course.description || '暂无课程描述'}</p>
          ...
          <div className="sticky top-8">
            <Card className="border border-gray-200 shadow-sm overflow-hidden">
              <CardContent className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-6">开始学习</h3>
